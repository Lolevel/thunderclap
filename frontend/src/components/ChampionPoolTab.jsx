                ...
                <>
                  ...
                  <div className="hidden md:block overflow-x-auto">
                    <table className="w-full">
                      ...
                      <tbody>
                        {team_champion_pool.map((champ, index) => {
                          const isExpanded = expandedChampions.has(
                            champ.champion_id
                          );
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      ...
                      {((favorite_bans?.phase_1 &&
                        favorite_bans.phase_1.length > 5) ||
                        (bans_against?.phase_1 &&
                          bans_against.phase_1.length > 5)) && (
                        <button
                          onClick={() =>
                            setExpandedBansPhase1(!expandedBansPhase1)
                          }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        {favorite_bans?.phase_1 &&
                        favorite_bans.phase_1.length > 0 ? (
                          <div className="space-y-2">
                            {favorite_bans.phase_1
                              .slice(0, expandedBansPhase1 ? undefined : 5)
                              .map((ban, idx) => (
                                <div
                                  key={idx}
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      ...
                      {((favorite_bans?.phase_2 &&
                        favorite_bans.phase_2.length > 5) ||
                        (bans_against?.phase_2 &&
                          bans_against.phase_2.length > 5)) && (
                        <button
                          onClick={() =>
                            setExpandedBansPhase2(!expandedBansPhase2)
                          }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        {favorite_bans?.phase_2 &&
                        favorite_bans.phase_2.length > 0 ? (
                          <div className="space-y-2">
                            {favorite_bans.phase_2
                              .slice(0, expandedBansPhase2 ? undefined : 5)
                              .map((ban, idx) => (
                                <div
                                  key={idx}
                                  className="group flex items-center gap-3 p-3 bg-gradient-to-r from-surface-hover to-surface-hover/50 rounded-lg border border-border/30 hover:border-primary/30 transition-all"
                ...
                >
                  {(() => {
                    ...
                    if (
                      ...
                      predictions[0].predicted_lineup
                    ) {
